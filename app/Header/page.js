      ...
      <>
        ...
        <div className={`${theme === "light" ? "bg-stone-200" : "bg-gray-800"}`}>
          ...
          >
            ...
            <div className="flex items-center space-x-4 text-stone-800 lg:block hidden shadow-lg rounded-full bg-stone-100 pt-2 pl-3">
              <ul
                className={`flex space-x-4 ${theme === "light" ? "text-gray-700" : "text-gray-50"}`}
              >
                <li>
                  <a
